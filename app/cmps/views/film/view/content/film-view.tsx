...
export const FilmView = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          'transition-colors duration-700 landscape:h-full',
          {
            'bg-background': isSmallScreen || viewHovered,
          },
          className,
        )}
      >
        ...
        <div className='relative z-1 flex h-full w-full flex-col'>
          <div
            className={cn(
              'w-full group-hover:h-auto group-hover:min-h-64 md:h-64 md:not-landscape:h-48 group-hover:md:not-landscape:min-h-48 max-md:landscape:h-full',
              {},
            )}
          >
