...
#define EDGE_CELL_SCALING_BORDER_THICKNESS 1
//#define EDGE_BORDER_THICKNESS_MIN 0.
//#define EDGE_BORDER_THICKNESS_MAX 1.
#define EDGE_BORDER_SMOOTHNESS_BASE 0.7 // defined as a percentage of border thickness
...
Plot plot() {
    ...
    float borderRoundnessScale = 0.1;
        ...
        cellScale = neighborXAvgOffset / 2.;
            ...
            borderThicknessScale = max(cellScale * 0.025, 0.05);
        #endif
        #if EDGE_CELL_SCALING_BORDER_SMOOTHNESS == 1
            borderSmoothnessScale = (1./(cellScale)) * 0.0075;
        #endif
